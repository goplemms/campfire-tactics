...
D14) *and* an equipment def (effect) sharing one id; `equip`/`unequip` move it stash↔slot in
Camp/Pre-deployment. Weapons re-enter via **authored grants/drops** (the relic) and a future
